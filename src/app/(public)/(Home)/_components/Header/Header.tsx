    ...
    <header className="h-[72px] px-4 flex items-center justify-between top-0 z-90 bg-zinc-900/50 backdrop-blur-md w-full fixed">
      <div className="flex items-center text-lg gap-4">
        ...
        <a
          ...
          target="_blank"
          rel="nofollow"
          href="mailto:abdulmoizsheikhh@gmail.com"
          aria-label="Email"
        >
          <svg
            stroke="currentColor"
          ...
          >
            <g id="Layer_2">
              <path
                id="Icons"
                d="M0 11.283V8a8 8 0 0 1 8-8h112a8 8 0 0 1 8 8v3.283l-64 40zm66.12 48.11a4 4 0 0 1-4.24 0L0 20.717V88a8 8 0 0 0 8 8h112a8 8 0 0 0 8-8V20.717z"
              ></path>
            </g>
          </svg>
        </a>
