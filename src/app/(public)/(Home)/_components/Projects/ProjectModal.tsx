...
const ProjectModal = ({
  ...
  return (
    <motion.div
      ...
      className="bg-slate-900/20 rounded-md backdrop-blur p-8 fixed inset-0 z-50 grid place-items-center overflow-y-scroll cursor-pointer w-full h-full"
    >
      <motion.div
        ...
        className="bg-gradient-to-br h-[90%] text-white py-2 rounded-lg w-full max-w-3xl mx-auto shadow-xl cursor-default relative overflow-hidden"
      >
