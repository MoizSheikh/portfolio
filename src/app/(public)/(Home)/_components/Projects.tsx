...
const Projects = () => {
  ...
  return (
    <>
      <div className="py-16 w-full md:w-10/12 lg:w-9/12 xl:w-8/12 mx-auto">
        ...
        <div className="relative">
          <div
            className={`grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4 mx-auto justify-center flex-wrap ${
              showAll ? "overflow-visible " : "overflow-hidden max-h-[450px]"
            }`}
          >
      ...
      <AnimatePresence>
        {selectedProject &&
          (() => {
            const { id, name, description, techStack, img } = selectedProject;
            ...
            return (
              <motion.div
                ...
                className="bg-slate-900/20 rounded- backdrop-blur p-8 fixed inset-0 z-50 grid place-items-center overflow-y-scroll cursor-pointer w-full h-full"
              >
                <motion.div
                  ...
                  className="bg-gradient-to-br h-[90%] text-white p-6 rounded-lg w-full max-w-3xl shadow-xl cursor-default relative overflow-hidden"
                >
    ...
    //       Projects <span>.</span>
    //     </h2>
    //     <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4 mx-auto justify-center flex-wrap">
    //       {projectsData.map((project, index) => {
    //         const { id, name, description, techStack, img } = project;
    //         return (
    //           <ProjectCard
